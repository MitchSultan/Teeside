...
export const properties: Property[] = [
  ...
  },
  {
    ...
    constructionYear: 2024,
    neighborhood: 'Kamakis',
    neighborhoodSlug: 'kamakis',
    address: 'Hospital Road, Kamakis, Nairobi',
    description: 'Premium executive apartment in Kamakis. Ideal for corporate lets with proximity to major hospitals, embassies, and the CBD. High-end finishes throughout.',
